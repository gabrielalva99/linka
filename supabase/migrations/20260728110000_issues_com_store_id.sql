-- A tela agrupava os problemas pelo NOME da loja. Duas lojas homônimas de redes
-- diferentes ("Casas Bahia Centro" existe em toda cidade) colapsavam no mesmo
-- bloco, e quem fosse resolver iria ao endereço errado. Agrupa por id, e o nome
-- vira link para a loja.
--
-- Precisa de drop: trocar a ORDEM das colunas de uma view não é permitido por
-- "create or replace".
